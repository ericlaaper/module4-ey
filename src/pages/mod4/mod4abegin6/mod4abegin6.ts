...
/**
 * Generated class for the Mod4abegin6Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-mod4abegin6',
  templateUrl: 'mod4abegin6.html',
})
export class Mod4abegin6Page {
  ...
  verder(){
    this.navCtrl.push('Mod4page25Page')
  }
