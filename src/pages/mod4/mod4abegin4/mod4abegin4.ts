...
/**
 * Generated class for the Mod4abegin4Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-mod4abegin4',
  templateUrl: 'mod4abegin4.html',
})
export class Mod4abegin4Page {
  ...
  verder(){
    this.navCtrl.push('Mod4page18Page')
  }
