...
/**
 * Generated class for the Mod4abegin5Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-mod4abegin5',
  templateUrl: 'mod4abegin5.html',
})
export class Mod4abegin5Page {
  ...
  verder(){
    this.navCtrl.push('Mod4page22Page')
  }
