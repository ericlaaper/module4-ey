...
/**
 * Generated class for the Mod4abegin8Page page.
 *
...
@IonicPage()
@Component({
  selector: 'page-mod4abegin8',
  templateUrl: 'mod4abegin8.html',
})
export class Mod4abegin8Page {
  ...
  verder(){
    this.navCtrl.push('Mod4page32Page')
  }
